...
import { validationSchema } from '@/validations/propertySchema'
...
const { uploadImage, url, urlImage } = useImage()
const { center, handlerPin, zoom } = useLocationMap()
  ...
  <v-card max-width="800" flat class="mx-auto my-10">
    ...
    <v-form class="mt-10">
      ...
      <div class="my-5">
        ...
        <img v-if="urlImage" :src="urlImage" alt="Property Image" class="w-50" />
        <img v-else :src="property?.image" alt="Property Image" class="w-50" />
      </div>
      ...
      <v-checkbox v-model="pool.value.value" label="Alberca"></v-checkbox>
